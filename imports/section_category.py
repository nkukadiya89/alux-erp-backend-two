...
class DieCategoryBulkImportAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            existing_names = set(DieCategory.objects.values_list("name", flat=True))
            ...
            with transaction.atomic():
                DieCategory.objects.bulk_create(objects_to_create, batch_size=1000)
