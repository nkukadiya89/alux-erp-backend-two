...
class DieSubCategoryBulkImportAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            existing_names = set(DieSubCategory.objects.values_list("name", flat=True))
            ...
            with transaction.atomic():
                DieSubCategory.objects.bulk_create(objects_to_create, batch_size=1000)
